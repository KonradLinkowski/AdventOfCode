...
words.forEach((line) => {
    if (operator[line[5]](parseInt(registers[line[4]] ? registers[line[4]] : 0), parseInt(line[6]))) {
        registers[line[0]] = operator[line[1]](parseInt(registers[line[0]] ? registers[line[0]] : 0), parseInt(line[2]));
    }
});
